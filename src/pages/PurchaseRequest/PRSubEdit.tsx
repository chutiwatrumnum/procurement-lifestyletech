// PRSubEdit.tsx - Edit mode for Sub PR (draft only)
...
export default function PRSubEdit() {
  const { id } = useParams();
  ...
  useEffect(() => {
    async function loadData() {
      ...
      try {
        ...
        // Check if it's a draft and sub type
        if (pr.status !== 'draft') {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">แก้ไขใบขอซื้องานย่อย (Draft)</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>ข้อมูลงานย่อย</CardTitle>
        </CardHeader>
